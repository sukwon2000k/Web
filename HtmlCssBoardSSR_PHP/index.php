...
<!-- php는 결국 사용자가 보는 페이지를 echo 하기에 html 태그문을 그냥 쓰면 자동 echo -->
<?php
    ...
    $db=mysqli_connect('localhost', 'hello2026', 'a1s2d3f4!', 'hello2026'); //DB주소, DB접속아이디, DB접속비번, DB명
    mysqli_query($db, 'set names utf8'); //한글깨짐 방지

    //원하는 쿼리문 수행(SQL언어 - web_board테이블의 모든 데이터를 번호기준 내림차순으로..[최신글 순으로])
    ...
    <div class="board_wrap">
        ...
        <div class="board_list_wrap">
            ...
            <div class="board_pagination">
                <a href="" class="btn">&lt;&lt;</a>
                <a href="" class="btn">&lt;</a>
                <a href="" class="btn selected">1</a> <!-- 클래스 명이 2개.. btn + selected(JS로 선택변경할때 이 클래스 명을 다른 버튼으로 이동)-->
