<?php
    ...
    //닷홈 호스팅을 사용하면 이미 Database가 설치되어 있으면..
    //미리 표를 만들어 놓고 데이터만 삽입하는 것이 가능함.
    //데이터를 삽입하는 작업은 SQL이라는 데이터베이스 전용 언어를 사용

    //MYSQL DBMS에 접속하여 memo 테이블에 이름$name, 메세지$message 데이터를 삽입하기
    //1. MYSQL에 접속하기
    $db= mysqli_connect('localhost','hello2026','a1s2d3f4!','hello2026'); //DB서버URL, DB접속 아이디, DB접속 비밀번호, DB명
