<?php
    ...
    <form action='./aaa.php' method='get'>
        <input type='text' placeholder='이름을 입력하세요.' name='nickname' value='$nickname'>
        <input type='email' placeholder='이메일 입력하세요' name='email' value='$email'>
